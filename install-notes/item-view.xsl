...
<xsl:stylesheet
    ...
    <xsl:template name="itemSummaryView-DIM-fields">
        ...
        <xsl:choose>
            ...
            <xsl:when test="$clause = 3">
                ...
                <xsl:if test="dim:field[@element='date' and not(@qualifier) and descendant::text()]">
                    ...
                    <div class="simple-item-view-other">
                        ...
                        <span>
                            <a>
                                <xsl:value-of select="dim:field[@element='date']"/>
                            </a>
                ...
                <xsl:if test="dim:field[@element='identifier' and @qualifier='other' and descendant::text()]">
                    ...
                    <div class="simple-item-view-other">
                        <span class="bold">Collection name:</span>
                        <a>
            ...
            <!-- identifier.uri row -->
            <xsl:when
                    test="$clause = 4 and (dim:field[@element='identifier' and @qualifier='uri' and descendant::text()])">
                <div class="simple-item-view-other">
            ...
            <xsl:when test="$clause = 5">
                ...
                <xsl:if test="dim:field[@element='title' and not(@qualifier) and descendant::text()]">
                ...
                <xsl:if test="dim:field[@element='rights' and @qualifier='holder' and descendant::text()]">
                    ...
                    <div class="simple-item-view-other">
                        <span class="bold">Copyright Holder:</span>
                        <a>
                            <xsl:value-of select="dim:field[@element='rights'][@qualifier='holder']"/>
                        </a>
            ...
            <!-- date.issued row -->
            <xsl:when
                    test="$clause = 6 and (dim:field[@element='date' and @qualifier='issued' and descendant::text()])">
                <div class="simple-item-view-other">
            ...
            <!-- Description row -->
            <xsl:when
                    test="$clause = 8 and (dim:field[@element='description' and not(@qualifier) and descendant::text()])">
                <div class="simple-item-view-description">
